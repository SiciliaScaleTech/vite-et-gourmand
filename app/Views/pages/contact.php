<section class="hero-banner text-center py-4">
            ...
            <div class="mt-4">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <p class="fw-bold mb-0">jose.santos@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <?php if (isset($_GET['status']) && $_GET['status'] === 'success'): ?>
                <div class="card border-0 shadow-sm p-5 rounded-4 text-center bg-light">
                    ...
                    <div class="mt-4">
                        <a href="<?= BASE_URL ?>index.php?page=home" class="btn btn-cheddar rounded-pill px-4 fw-bold">Retour à l'accueil</a>
                    </div>
                </div>
            ...
            <?php else: ?>
                ...
                <?php if (isset($_GET['status']) && $_GET['status'] === 'error'): ?>
                    <div class="alert alert-danger rounded-pill border-0 shadow-sm mb-3 text-center">
                        Veuillez remplir tous les champs correctement.
                    </div>
                <?php endif; ?>

                <?php if (isset($_GET['status']) && $_GET['status'] === 'server_error'): ?>
                    <div class="alert alert-danger rounded-pill border-0 shadow-sm mb-3 text-center">
                ...
                <div class="card border-0 shadow-sm p-4 rounded-4">
                    <form action="<?= BASE_URL ?>index.php?page=contact-process" method="POST" novalidate>
                        <div class="row g-3">
                            <div class="col-md-6">
